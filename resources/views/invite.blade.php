...
<body>
    <div>
        <img src="/images/xvzoe-landing.jpg" alt="XV Zoe" usemap="#invitemap" {{-- <iframe width="1" height="1" wmode="transparent"
            src="https://www.youtube.com/embed/e8jN1-HC-Vc?si=ThLVq2OwavjSlZOA" frameborder="0" autoplay loop></iframe> --}} </div>
        ...
        <map name="invitemap">
            ...
            <area target="_blank" alt="palacio de hierro" title="palacio de hierro"
                href="https://www.elpalaciodehierro.com/buscar?eventId=387633" coords="500,2785,555,2830"
                shape="rect">
        </map>
